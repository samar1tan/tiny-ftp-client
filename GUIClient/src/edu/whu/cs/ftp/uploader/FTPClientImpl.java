...
//        Downloader downloader = new Downloader(new FTPPath(remotePath))
    ...
    @Override
    public void uploadFile(String localPath, String remotePath, FTPClient ftp, StatusPublisher publisher) throws IOException, SQLException {
    ...
    @Override
    public void uploadDirectory(String localPath, String remotePath, FTPClient ftp, StatusPublisher publisher) throws IOException, SQLException {
        UpLoader uploader = new UpLoader(ftp, controlSocket, publisher);
        Path local_path = Paths.get(localPath);
    ...
    public static void main(String[] args) throws Exception {
        ...
        ftp.uploadDirectory("C:\\ftp_client\\b", "/a", ftp, publisher);
        ftp.quit();
    }
}